...
'<div class="sic-timeline-item-hover" />')},skinSelectors:{vector:$('.mw-body'),gemmaonline:$('section#mainContent'),rhswiki:$('main.mainContainer'),getSelector:function(){if(SmartComments.activeSkin==='gemmaonline'){return this.gemmaonline;}else if(SmartComments.activeSkin==='rhswiki'){return this.rhswiki;}else{return this.vector;}},getMargin:function(){if(SmartComments.activeSkin==='gemmaonline'){return 135;}else if(SmartComments.activeSkin==='rhswiki'){return 115;}else{return 80;}}},isSkinSupported:function(){return SmartComments.Panels.CommentTimeline.supportedSkins.indexOf(SmartComments.activeSkin)!==-1;},createBase:function(){this.templates.base.appendTo(SmartComments.getNodeRoot(true)).css({top:-this.skinSelectors.getSelector().position().top-this.skinSelectors.getMargin()});this.bindEvents();},addToBase:function(comment){var self=this,id=typeof comment.data_id!=="undefined"?comment.data_id:comment;if(this.idsHandled.indexOf(id)!==-1){return;}setTimeout(function(){var item=self.
