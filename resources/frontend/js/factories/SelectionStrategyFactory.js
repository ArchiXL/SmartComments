 ...
 */
const { TextSelectionStrategy } = require('../strategies/TextSelectionStrategy.js');
const { ImageSelectionStrategy } = require('../strategies/ImageSelectionStrategy.js');
const { SVGSelectionStrategy } = require('../strategies/SVGSelectionStrategy.js');
const { DynamicBlockSelectionStrategy } = require('../strategies/DynamicBlockSelectionStrategy.js');
