 ...
 */
const HIGHLIGHT_CLASS_PREFIX = 'smartcomment-hl-';
const DATA_COMMENT_ID_ATTR = 'data-comment-id';
const DATA_SVG_ID_ATTR = 'data-svg-id';
 ...
 */
function sanitizeCommentId(commentId) {
 ...
 */
function hasOtherSmartCommentClasses(element, excludeClass) {
    return Array.from(element.classList).some(cls =>
        cls.startsWith(HIGHLIGHT_CLASS_PREFIX) && cls !== excludeClass
    );
}
 ...
 */
function cleanupHighlightElement(element, highlightClass) {
 ...
 */
function findHighlightedElements(scopeElement, commentId) {
 ...
 */
function unwrapEmptySpan(spanElement) {
 ...
 */
function setElementAttributes(element, commentId, svgId = null) {
 ...
 */
function batchRemoveHighlights(scopeElement, highlightClass, customCleanup = null) {
